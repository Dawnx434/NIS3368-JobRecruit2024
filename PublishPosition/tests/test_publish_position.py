...
from PublishPosition.views import publish_position
from PublishPosition.models import Position


class PublishPositionTest(TestCase):
    ...
    def setUp(self):
        ...
        url = reverse('PublishPosition:publish')
    ...
    def test_index_url_resolve_index_view(self):
        view = resolve('/position/publish/')
        self.assertEqual(view.func, publish_position)
...
class SuccessfulPublishTest(TestCase):
    ...
    def setUp(self):
        ...
        self.success_response = self.client.post(reverse('PublishPosition:publish'), data)
