...
from PublishPosition.views import view_position_detail
from PublishPosition.models import Position


class PositionDetailTest(TestCase):
    ...
    def test_index_url_resolve_index_view(self):
        view = resolve('/position/view/1/')
        self.assertEqual(view.func, view_position_detail)
